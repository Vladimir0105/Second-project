...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	CalRunning := (CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * (float64(r.Training.Duration.Hours()) * MinInHours)
	return CalRunning
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	messageRunning := r.Training.TrainingInfo()
...
func (w Walking) Calories() float64 {
	...
	CalWalking := ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(SpeedInms, 2) / (w.Height / CmInM))) * CaloriesSpeedHeightMultiplier * w.Training.Weight) * float64(w.Training.Duration.Hours()) * MinInHours
	return CalWalking
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	messageWalking := w.Training.TrainingInfo()
	return messageWalking
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	SpeedInPool := float64(s.LengthPool) * float64(s.CountPool) / MInKm / s.Training.Duration.Hours()
	return SpeedInPool
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	CalSwimming := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Training.Weight * s.Training.Duration.Hours()
	return CalSwimming
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	messageSwimming := s.Training.TrainingInfo()
	return messageSwimming
}
